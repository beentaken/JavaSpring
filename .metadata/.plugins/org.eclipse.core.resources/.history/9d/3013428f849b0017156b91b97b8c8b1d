...
@Entity
@Table(name = "residentteacher" )
public class ResidentialTeacher implements Serializable {
	...
	public String toString() {
		return "ResidentialTeacher [id=" + id + ", total_num_of_resident=" + total_num_of_resident
