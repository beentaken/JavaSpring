...
@Entity
@Table(name = "examtimewise" )
public class Examtimewise implements Serializable {
	...
	public String toString() {
		return "Examtimewise [id=" + id + ", nameofteacher_info1=" + nameofteacher_info1 + ", building_info1="
